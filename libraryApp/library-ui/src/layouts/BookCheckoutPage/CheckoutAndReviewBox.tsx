...
export const CheckoutAndReviewBox: React.FC<{ 
	...
	const copiesAvailable = () => props.book && props.book.copiesAvailable && props.book.copiesAvailable > 0;

	const displayAvailableText = () => <h4 className="text-success">Available</h4>;

	const displayWaitListText = () => <h4 className="text-danger">Wait List</h4>;
		...
		<div className={props.mobile ? 'card d-flex mt-5' : 'card col-3 container d-flex mb-5'}>
			<div className="card-body container">
				<div className="mt-3">
					...
					<hr />
					{copiesAvailable() ? displayAvailableText() : displayWaitListText()}
					<div className="row">
