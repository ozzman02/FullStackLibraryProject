...
export const SearchBooksPage = () => {
	...
	const renderEmptyPaginationResults = () => {
		return (
			<div className="m-5">
		...
		<div>
			<div className="container">
				<div>
					<div className="row mt-5">
						...
						<div className="col-4">
							<div className="dropdown">
								...
								<ul className="dropdown-menu" aria-labelledby="dropdownMenutButton1">
					...
					{totalAmountOfBooks > 0 ? renderPaginationResults() : renderEmptyPaginationResults()}
